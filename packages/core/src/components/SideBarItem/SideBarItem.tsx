import { ListItem, ListItemIcon, ListItemIconProps, Typography } from '@mui/material';
...
const StyledListItemIcon = styled(({ selected, ...props }: ListItemIconProps & { selected: boolean }) => (
  <ListItemIcon {...props} />
))(
  ({ theme, selected }) => `
  min-width: auto;
