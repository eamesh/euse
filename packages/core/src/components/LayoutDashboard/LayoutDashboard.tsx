...
const StyledAppBar = styled(({ drawer, ...rest }: any & { drawer: boolean }) => <AppBar {...rest} />)`
...
const StyledDrawer = styled(Drawer)`
  ...
  width: ${({ theme }: any) => theme.drawer.width};
  flex-shrink: 0;
              ...
              <StyledToolbar>
                <Flex width="100%" alignItems="center" justifyContent="space-between" gap={3}>
                  ...
                  <Box>
                    ...
                    >
                      <IconButton data-testid="LayoutDashboard-log-out">
                        <ExitToAppIcon />
                      </IconButton>
                    </Tooltip>
                  </Box>
            ...
            <StyledToolbar>
              <Container maxWidth="lg">
                <Flex alignItems="center">
                  ...
                  <IconButton color="inherit" title={t`Log Out`}>
                    <ExitToAppIcon />
                  </IconButton>
                  {/* </Tooltip> */}
